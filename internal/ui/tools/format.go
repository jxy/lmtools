...
func FormatToolResult(notifier core.Notifier, cfg core.RequestConfig, result core.ToolResult) {
	if result.Error != "" {
...
func FormatToolResults(notifier core.Notifier, cfg core.RequestConfig, results []core.ToolResult) {
